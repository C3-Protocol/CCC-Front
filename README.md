...
To learn more before you start working with swap, see the following documentation available online:
...
* dex build --network ic ccc
* dfx canister --network ic install ccc
