export const idlFactory = ({ IDL }) => {
  ...
  const Result_16 = IDL.Variant({
    ok: IDL.Vec(IDL.Tuple(IDL.Text, IDL.Tuple(IDL.Text, IDL.Vec(IDL.Tuple(IDL.Text, IDL.Int))))),
    err: Error__1
  })
  ...
  const Hub = IDL.Service({
    accessoryBalanceOf: IDL.Func([IDL.Principal], [IDL.Vec(IDL.Tuple(IDL.Text, IDL.Nat))], ['query']),
    accessoryOwnersOf: IDL.Func([IDL.Text], [IDL.Vec(IDL.Tuple(IDL.Principal, IDL.Nat))], ['query']),
    accessoryProperties: IDL.Func([IDL.Text], [Result_7], ['query']),
    accessoryStreamingCallback: IDL.Func([StreamingCallbackToken], [StreamingCallbackResponse], ['query']),
    accessoryTokenMetadataByIndex: IDL.Func([IDL.Text], [Result_18], []),
    addOwner: IDL.Func([IDL.Principal], [IDL.Vec(IDL.Principal)], []),
    addPrincipalsToOgs: IDL.Func([IDL.Vec(IDL.Principal)], [IDL.Vec(IDL.Principal)], []),
    addPrincipalsToWhitelist: IDL.Func([IDL.Vec(IDL.Principal)], [IDL.Vec(IDL.Principal)], []),
    ...
    authorizeAccessory: IDL.Func([AuthorizeRequest, IDL.Principal], [Result], []),
    ...
    blocksRedeemed: IDL.Func([], [IDL.Vec(IDL.Tuple(IDL.Nat64, IDL.Bool))], []),
    bulkAccessoryTokenMetadataByIndex: IDL.Func([IDL.Vec(IDL.Text)], [Result_17], []),
    bulkGetNftStats: IDL.Func([IDL.Vec(IDL.Text)], [Result_16], ['query']),
    bulkTokenMetadataByIndex: IDL.Func([IDL.Vec(IDL.Text), IDL.Bool], [Result_15], ['query']),
    ...
    createAccessoryToken: IDL.Func([AccessoryEgg, IDL.Opt(IDL.Nat)], [Result_8], []),
    currTokensOnSale: IDL.Func([IDL.Nat], [Result_5], ['query']),
    eventCallback: IDL.Func([Message], [], []),
    getAllAccessoryMetadata: IDL.Func([], [IDL.Vec(IDL.Tuple(IDL.Text, AccessoryMetadata))], []),
    ...
    getApproved: IDL.Func([TokenIndex__1], [IDL.Vec(IDL.Principal)], ['query']),
    getAuthorized: IDL.Func([IDL.Text], [IDL.Vec(IDL.Principal)], ['query']),
    getAuthorizedForAccessory: IDL.Func([IDL.Text, IDL.Principal], [IDL.Vec(IDL.Principal)], ['query']),
    getAvailableNfts: IDL.Func([], [IDL.Vec(IDL.Nat)], ['query']),
    getBalance: IDL.Func([], [ICP], []),
    getBlockRedemptions: IDL.Func([], [IDL.Vec(IDL.Tuple(IDL.Nat64, IDL.Bool))], ['query']),
    ...
    getEntries: IDL.Func(
      [],
      [IDL.Vec(IDL.Tuple(IDL.Text, IDL.Tuple(IDL.Opt(IDL.Principal), IDL.Vec(IDL.Principal)), Token__1))],
      ['query']
    ),
    getEventCallbackStatus: IDL.Func([], [CallbackStatus], []),
    getListings: IDL.Func([], [IDL.Vec(IDL.Tuple(NftPhotoStoreCID, Listings))], ['query']),
    ...
    getNftPriceBreakdown: IDL.Func([], [IDL.Vec(IDL.Tuple(IDL.Nat, Price))], []),
    ...
    getOwnerToNft: IDL.Func([], [IDL.Vec(IDL.Tuple(IDL.Principal, IDL.Vec(IDL.Text)))], ['query']),
    getRarity: IDL.Func([IDL.Text], [IDL.Float64], ['query']),
    getReservedNfts: IDL.Func([], [IDL.Vec(IDL.Tuple(IDL.Principal, IDL.Vec(IDL.Nat)))], ['query']),
    getRoyaltyFeeRatio: IDL.Func([], [IDL.Nat], ['query']),
    getSoldListings: IDL.Func([], [IDL.Vec(IDL.Tuple(NftPhotoStoreCID, SoldListings))], ['query']),
    getStorageCanisterId: IDL.Func([], [IDL.Opt(IDL.Principal)], ['query']),
    getTotalMinted: IDL.Func([], [IDL.Nat], ['query']),
    getUserBalances: IDL.Func([], [IDL.Vec(IDL.Tuple(IDL.Principal, IDL.Int))], ['query']),
    ...
    isAuthorizedForAccessory: IDL.Func([IDL.Text, IDL.Principal, IDL.Principal], [IDL.Bool], ['query']),
    ...
    mutateAccessories: IDL.Func([IDL.Text, IDL.Vec(MutationRequest)], [Result_11], []),
    ...
    ownerTokenEntries: IDL.Func([], [IDL.Vec(IDL.Tuple(IDL.Principal, IDL.Vec(IDL.Text)))], ['query']),
    ...
    reservedTimeEntries: IDL.Func([], [IDL.Vec(IDL.Tuple(IDL.Principal, Time))], ['query']),
    resetReserved: IDL.Func([], [Result_5], []),
    resetSale: IDL.Func([IDL.Vec(IDL.Tuple(IDL.Nat, IDL.Nat))], [IDL.Vec(IDL.Nat)], []),
    ...
    setUpSale: IDL.Func([IDL.Vec(IDL.Tuple(IDL.Nat, IDL.Nat))], [IDL.Vec(IDL.Nat)], []),
    ...
    tokenMetadataByIndex: IDL.Func([IDL.Text, IDL.Bool], [Result_2], []),
    transfer: IDL.Func([IDL.Principal, IDL.Text], [Result], []),
    transferAccessory: IDL.Func([IDL.Principal, IDL.Text, IDL.Principal, IDL.Nat], [Result_1], []),
    transferFrom: IDL.Func([IDL.Principal, IDL.Principal, TokenIndex__1], [TransferResponse__1], []),
    ...
    withdrawFunds: IDL.Func([], [IDL.Variant({ Ok: BlockIndex, Err: TransferError })], []),
