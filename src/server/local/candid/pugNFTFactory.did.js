export const idlFactory = ({ IDL }) => {
  ...
  const AirDropResponse = IDL.Variant({
    'ok' : CanvasIdentity,
    'err' : IDL.Variant({
      'AlreadyClaim' : IDL.Null,
      'NotInAirDropListOrAlreadyClaim' : IDL.Null,
    }),
  });
  ...
  const TokenDetails = IDL.Record({
    ...
    'attr8' : ComponentAttribute,
    'attr9' : ComponentAttribute,
    'attr10' : ComponentAttribute,
    'attr11' : ComponentAttribute,
    'attr12' : ComponentAttribute,
  });
  ...
  const NFT = IDL.Service({
    ...
    'claimAirdrop' : IDL.Func([], [AirDropResponse], []),
    ...
    'mintStats' : IDL.Func([], [Time, IDL.Nat], ['query']),
    ...
    'setCCCMintfeeRatio' : IDL.Func([IDL.Nat], [IDL.Nat], []),
    'setCCCMintfeeTo' : IDL.Func([IDL.Principal], [IDL.Principal], []),
    'setDataUser' : IDL.Func([IDL.Principal], [IDL.Principal], []),
