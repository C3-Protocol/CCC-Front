export const idlFactory = ({ IDL }) => {
  ...
  const ThemeCanvas1155 = IDL.Service({
    ...
    'getAccInfo' : IDL.Func([IDL.Principal], [AccInfo], ['query']),
    ...
    'invitePainters' : IDL.Func([IDL.Vec(IDL.Text)], [IDL.Bool], []),
