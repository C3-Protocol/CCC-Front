export const idlFactory = ({ IDL }) => {
  ...
  const TokenDetails = IDL.Record({
    ...
    accessories: ComponentAttribute,
    body: ComponentAttribute,
    eyes: ComponentAttribute,
    hair: ComponentAttribute,
    hats: ComponentAttribute,
    pets: ComponentAttribute,
    clothes: ComponentAttribute,
    glassess: ComponentAttribute,
    rarityScore: IDL.Float64
  })
  ...
  const NFT = IDL.Service({
    ...
    getNftStoreCIDByIndex: IDL.Func([], [IDL.Principal], ['query']),
